...
func (server *Server) UpdateUser(ctx context.Context, req *pb.UpdateUserRequest) (*pb.UpdateUserResponse, error) {
    authPayload, err := server.authorizeUser(ctx, []string{util.DEPOSITOR_ROLE, util.BANKER_ROLE})
    if err != nil {
    ...
    if authPayload.Role != util.BANKER_ROLE && authPayload.Username != req.GetUsername() {
